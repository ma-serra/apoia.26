...
module.exports = withSentryConfig(
    module.exports, {
        ...
        webpack: {
            // Automatically tree-shake Sentry logger statements to reduce bundle size (migrated from disableLogger)
            treeshake: {
                removeDebugLogging: true
            },
            // Enables automatic instrumentation of Vercel Cron Monitors (migrated from automaticVercelMonitors)
