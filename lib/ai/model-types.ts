...
const ModelArray: ModelArrayType[] = [
    ...
    { id: 19, name: 'azure-gpt-5.0-mini', provider: ModelProvider.AZURE, cachedInputTokenPPM: 0.025, inputTokenPPM: 0.25, outputTokenPPM: 2, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF] },
    { id: 20, name: 'azure-gpt-5.0-nano', provider: ModelProvider.AZURE, cachedInputTokenPPM: 0.005, inputTokenPPM: 0.05, outputTokenPPM: 0.4, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF] },
    { id: 21, name: 'azure-gpt-5.0', provider: ModelProvider.AZURE, cachedInputTokenPPM: 0.125, inputTokenPPM: 1.25, outputTokenPPM: 10, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF] },
    { id: 21, name: 'azure-gpt-5.0-chat', provider: ModelProvider.AZURE, cachedInputTokenPPM: 0.75, inputTokenPPM: 2, outputTokenPPM: 8, status: StatusDeLancamento.PUBLICO, supportedFileTypes: [FileTypeEnum.PDF] },
